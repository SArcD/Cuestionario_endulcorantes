...
# Gráfica IAS Barras
fig.savefig('ias_barras.png', bbox_inches='tight', pad_inches=0, dpi=300)
...
def generar_pdf(datos, ias_respuestas, edulcorantes_respuestas, ias_analisis, edulcorantes_analisis, df_semaforo):
    ...
    try:
        ...
        page_width = pdf.w - 2 * pdf.l_margin  # ancho útil de página
        x_center_radar = (page_width - radar_w) / 2 + pdf.l_margin  # X centrada

        pdf.image('ias_radar.png', x=x_center_radar, w=radar_w)
        pdf.ln(5)
    except Exception as e:
